        ...
        return (
            <div>
                <div class="flex-header" style={{}}>
                    ...
                    <div className="flex-icon">
                      <i className="bi bi-window-fullscreen icon-size"></i>
                      <h6 id="profile">Irrperks.dev</h6>
                    </div>
                    <div className="flex-icon">
                      <i className="bi bi-house-door-fill icon-size"></i>
                      <h6 id="profile">{resume.basics.location.address}, {resume.basics.location.city}</h6>
                    </div>
                </div>
            </div>
